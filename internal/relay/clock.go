...
// (15 s heartbeat / 30 s offline flip, §6), mailbox TTL (§4), pairing-window
// expiry (§3.1), and rate-limit refill all read time exclusively through
// this interface.
...
// and fires due timers synchronously, in deadline order.
...
// calling goroutine with the clock unlocked, so they may schedule or reset
// timers.
